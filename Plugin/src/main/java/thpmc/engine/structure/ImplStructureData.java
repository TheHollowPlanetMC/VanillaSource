package thpmc.engine.structure;
...
public class ImplStructureData extends StructureData{
    ...
    public static void loadAllStructureData() {
        ...
        THPEngine.getPlugin().getLogger().info("Loading structure data...");
        File dir = new File("plugins/THP-Engine/structure_data");
        ...
        if (files != null) {
            for (File file : files) {
                THPEngine.getPlugin().getLogger().info(file.getName());
