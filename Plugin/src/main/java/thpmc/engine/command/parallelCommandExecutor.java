...
import thpmc.engine.structure.StructureData;
import thpmc.engine.util.RegionBlocks;
...
public class parallelCommandExecutor implements CommandExecutor, TabExecutor {
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        if (args.length == 2) {
            ...
            if(args[0].equals("join-universe")){
                list.addAll(THPEngineAPI.getInstance().getAllUniverseName());
            }
