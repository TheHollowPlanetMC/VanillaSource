package thpmc.vanilla_source.nms.v1_19_R1.packet;
...
import thpmc.vanilla_source.nms.v1_19_R1.BlockChangePacketHandler;
import thpmc.vanilla_source.nms.v1_19_R1.MultiBlockChangePacketHandler;
import thpmc.vanilla_source.nms.v1_19_R1.NMSHandler;
...
public class PacketManager {
    ...
    public static Set<Object> createMultiBlockChangePacket(ParallelWorld parallelWorld, Set<BlockPosition3i> blocks) {
        ...
        for(Map.Entry<BlockPosition3i, Set<BlockPosition3i>> entry : chunkMap.entrySet()){
            ...
            PacketPlayOutMultiBlockChange packet = new PacketPlayOutMultiBlockChange(sectionPos, coordList, dataArray, true);
            packets.add(packet);
        }
    ...
    public static @Nullable Object createLightUpdatePacketAtPrimaryThread(ParallelChunk parallelChunk) {
        ...
        Chunk chunk = ((CraftChunk) world.getChunkAt(parallelChunk.getChunkX(), parallelChunk.getChunkZ())).getHandle();
        ...
        return new PacketPlayOutLightUpdate(
                ...
                ((CraftWorld) world).getHandle().k().o(), null, null, true);
    }
